...
def get_weather_data():
    ...
    showinfo(f' {city.title()} Weather Details',
            f' Weather: {weather} \n 
...
city_label.grid(row  = 1, column = 1, pady = 10)

btn = tk.Button(win, text = "Get the Weather details", bd = 1, commamd_= get_weather_data)
